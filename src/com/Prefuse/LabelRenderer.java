...
/**
 ...
 protected Shape getRawShape(VisualItem item) {
     ...
     // hahahahhahahahaha,this is what we need!!!!!!!!!!!!
     // get bounding box dimensions
     
     
     double w=10, h=10;
     double width = Double.parseDouble(getText(item));
     if (width<7) {
		width = 7.0d;
	}
     w = 4.5*Math.log(1.5*width);
     
     
//     switch ( m_imagePos ) {
//     case Constants.LEFT:
//     case Constants.RIGHT:
//    	 // originally, the dimensions of bounding box depend on the "m_textDIm.height",from the function computeTextDimensions()line:369
